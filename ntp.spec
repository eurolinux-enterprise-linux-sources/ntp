...
rm -f $RPM_BUILD_ROOT%{_sbindir}/sntp
...
* Tue Jan 26 2016 Miroslav Lichvar <mlichvar@redhat.com> 4.2.6p5-10
...
* Tue Jan 12 2016 Miroslav Lichvar <mlichvar@redhat.com> 4.2.6p5-9
...
* Fri Oct 16 2015 Miroslav Lichvar <mlichvar@redhat.com> 4.2.6p5-7
...
* Tue Apr 28 2015 Miroslav Lichvar <mlichvar@redhat.com> 4.2.6p5-5
...
* Mon Feb 23 2015 Miroslav Lichvar <mlichvar@redhat.com> 4.2.6p5-4
- fix typos in ntpd man page (#1194463)

* Thu Feb 19 2015 Miroslav Lichvar <mlichvar@redhat.com> 4.2.6p5-3
...
* Fri Dec 19 2014 Miroslav Lichvar <mlichvar@redhat.com> 4.2.6p5-2
...
* Mon Jul 15 2013 Miroslav Lichvar <mlichvar@redhat.com> 4.2.6p5-1
- update to 4.2.6p5 (#654004, #641800, #714079, #714084, #716968, #819781,
  #835155, #849319, #918275, #969052)
- bind broadcast client to new interfaces (#973807)
- allow selection of cipher for private key files (#749530)
- retry few times in ntpdate init script before giving up (#673198)
- print synchronization distance instead of dispersion in ntpstat (#830821)
- ignore duplicate servers from dhclient (#862983)
- add fourth server to default ntp.conf and use iburst (#667524, #623616)
- drop comment enabling local driver in default config (#816645)

* Thu Jan 10 2013 Miroslav Lichvar <mlichvar@redhat.com> 4.2.4p8-3
